...
/**
 * PrivateProfilePage component - Displays private profile message
 * Shows a user-friendly message when attempting to view a private profile
 * Uses the same background styling as the home page for consistency
 * 
 * @returns JSX element representing the private profile page
 */
