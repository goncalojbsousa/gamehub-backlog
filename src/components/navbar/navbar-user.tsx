        ...
        <>
            ...
            {menuOpen && (
                <div ref={menuRef} className="absolute mt-52 mr-36 bg-color_sec shadow-md border border-border_detail rounded-md w-48 p-2">
                    <Link href={`/user/${usernameSlug}`} className="flex px-4 py-2 text-color_text hover:bg-color_main rounded-md transition-colors duration-200 active:bg-color_click">
                    ...
                    <Link href="/settings" className="flex px-4 py-2 text-color_text hover:bg-color_main rounded-md transition-colors duration-200 active:bg-color_click">
