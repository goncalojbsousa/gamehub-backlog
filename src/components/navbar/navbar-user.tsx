...
export const NavbarUser = ({ username, userImage }: UserProps) => {
        ...
        <>
            ...
            {menuOpen && (
                <div ref={menuRef} className="absolute mt-52 mr-36 bg-color_sec shadow-md border border-border_detail rounded-md w-48 p-2">
                    <Link href="/profile" className="flex px-4 py-2 text-color_text hover:bg-color_main rounded-md">
                    ...
                    <Link href="/settings" className="flex px-4 py-2 text-color_text hover:bg-color_main rounded-md">
                    ...
                    <SignOutButton className="w-full flex justify-start itens-center px-4 py-2 text-color_text hover:bg-btn_logout rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" className="mr-2 mt-1 fill-color_icons" width="1em" height="1em" viewBox="0 0 24 24">
