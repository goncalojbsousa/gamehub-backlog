    ...
    return (
        <div className="mx-auto p-6 pt-0">
            ...
            <ul className="list-disc list-inside mb-4">
                <li>Our <a className="text-blue-600 hover:underline" href="/privacy">privacy policy</a>, which outlines the data we collect from you</li>
            </ul>
            ...
            <h2 className="text-2xl font-semibold mt-6 mb-4">What Do These Terms Cover?</h2>
            ...
            <h2 className="text-2xl font-semibold mt-6 mb-4">Eligibility Requirements</h2>
            ...
            <h2 className="text-2xl font-semibold mt-6 mb-4">Account Creation</h2>
