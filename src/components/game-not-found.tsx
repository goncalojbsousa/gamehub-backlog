...
/**
 * GameNotFound component - 404 error page for games
 * Displays a user-friendly error message when a game cannot be found
 * Provides navigation back to the home page
 * 
 * @returns JSX element representing the game not found error page
 */
    ...
    return (
        <div className="transition-colors duration-200 pt-24 relative min-h-screen flex flex-col justify-between">
            ...
            <main className='flex flex-col justify-center items-center flex-grow text-color_text'>
                {/* Error heading */}
                <h1 className='text-3xl font-bold bg-color_error rounded p-2'>UPS! Game Not Found</h1>
                
                {/* Error description */}
                <p className='text-lg mb-4 mt-2'>Sorry, we couldn&apos;t find the game you&apos;re looking for.</p>
